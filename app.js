...
var Player = exports.Player = function () {
    function Player(x, y, rgb, tool, id, nick) {
...
// ENDESGA 16 palette
//paleet
var palette = [[0xE4, 0xA6, 0x72], [0xB8, 0x6F, 0x50], [0x74, 0x3F, 0x39], [0x3F, 0x28, 0x32], [0x9E, 0x28, 0x35], [0xE5, 0x3B, 0x44], [0xFB, 0x92, 0x2B], [0xFF, 0xE7, 0x62], [0x63, 0xC6, 0x4D], [0x32, 0x73, 0x45], [0x19, 0x3D, 0x3F], [0x4F, 0x67, 0x81], [0xAF, 0xBF, 0xD2], [0x2C, 0xE8, 0xF4], [0x04, 0x84, 0xD1], [0x00, 0x00, 0x00], [0xFF, 0x00, 0x00], [0x00, 0xFF, 0x00], [0x00, 0x00, 0xFF], [0x00, 0xFF, 0x99], [0x5B, 0x3A, 0x29], [0x7A, 0x7B, 0x3D], [0x93, 0x52, 0x98], [0xD7, 0x9D, 0x50], [0x54, 0x54, 0x54], [0x1F, 0x1F, 0x1F], [0xFF, 0xDF, 0xA9], [0x53, 0xDE, 0x9B], [0x5B, 0xCF, 0xFA], [0xF5, 0xAB, 0xB9], [0xFF, 0xFF, 0xFF]];
var paletteIndex = 0;
...
var playerListWindow = exports.playerListWindow = new _windowsys.GUIWindow('Players', { closeable: false }, function (wdow) {
...
_global.PublicAPI.tool = {
	...
	updateToolbar: updateToolbar, /*code for le toolz*/
	allTools: tools,
...
_global.eventSys.once(_conf.EVENTS.misc.toolsRendered, function () {
  ...
  addTool(new Tool('Cut', _tool_renderer.cursors.cut, _Fx.PLAYERFX.NONE, _conf.RANK.OWNER, function (tool) {
		function drawText(ctx, str, x, y, centered) {
			ctx.strokeStyle = "#000000", ctx.fillStyle = "#FFFFFF", ctx.lineWidth = 2.5, ctx.globalAlpha = 0.5;
			if (centered) {
				x -= ctx.measureText(str).width >> 1;
